...
// SqlserverDatabaseIoStallQueuedMetricAttributeKey specifies the key of an attribute for the sqlserver.database.io.stall_queued metric.
type SqlserverDatabaseIoStallQueuedMetricAttributeKey string

const (
	SqlserverDatabaseIoStallQueuedMetricAttributeKeyPhysicalFilename SqlserverDatabaseIoStallQueuedMetricAttributeKey = "physical_filename"
	SqlserverDatabaseIoStallQueuedMetricAttributeKeyLogicalFilename  SqlserverDatabaseIoStallQueuedMetricAttributeKey = "logical_filename"
	SqlserverDatabaseIoStallQueuedMetricAttributeKeyFileType         SqlserverDatabaseIoStallQueuedMetricAttributeKey = "file_type"
	SqlserverDatabaseIoStallQueuedMetricAttributeKeyDirection        SqlserverDatabaseIoStallQueuedMetricAttributeKey = "direction"
)

// SqlserverDatabaseIoStallQueuedMetricConfig provides config for the sqlserver.database.io.stall_queued metric.
type SqlserverDatabaseIoStallQueuedMetricConfig struct {
	Enabled          bool `mapstructure:"enabled"`
	enabledSetByUser bool

	AggregationStrategy string                                               `mapstructure:"aggregation_strategy"`
	EnabledAttributes   []SqlserverDatabaseIoStallQueuedMetricAttributeKey `mapstructure:"attributes"`
}

func (ms *SqlserverDatabaseIoStallQueuedMetricConfig) Unmarshal(parser *confmap.Conf) error {
	if parser == nil {
		return nil
	}
...
func (ms *SqlserverDatabaseIoStallQueuedMetricConfig) Validate() error {
	for _, val := range ms.EnabledAttributes {
		switch val {
		case SqlserverDatabaseIoStallQueuedMetricAttributeKeyPhysicalFilename, SqlserverDatabaseIoStallQueuedMetricAttributeKeyLogicalFilename, SqlserverDatabaseIoStallQueuedMetricAttributeKeyFileType, SqlserverDatabaseIoStallQueuedMetricAttributeKeyDirection:
		default:
			return fmt.Errorf("metric sqlserver.database.io.stall_queued doesn't have an attribute %v, valid attributes: [physical_filename, logical_filename, file_type, direction]", val)
		}
	}
...
// SqlserverForwardedRecordsRateMetricConfig provides config for the sqlserver.forwarded_records.rate metric.
type SqlserverForwardedRecordsRateMetricConfig struct {
	Enabled          bool `mapstructure:"enabled"`
	enabledSetByUser bool
}

func (ms *SqlserverForwardedRecordsRateMetricConfig) Unmarshal(parser *confmap.Conf) error {
	if parser == nil {
		return nil
	}
...
// SqlserverTransactionActiveCountMetricConfig provides config for the sqlserver.transaction.active.count metric.
type SqlserverTransactionActiveCountMetricConfig struct {
	Enabled          bool `mapstructure:"enabled"`
	enabledSetByUser bool
}

func (ms *SqlserverTransactionActiveCountMetricConfig) Unmarshal(parser *confmap.Conf) error {
	if parser == nil {
		return nil
	}
...
// SqlserverSessionCountMetricConfig provides config for the sqlserver.session.count metric.
type SqlserverSessionCountMetricConfig struct {
	Enabled          bool `mapstructure:"enabled"`
	enabledSetByUser bool
}

func (ms *SqlserverSessionCountMetricConfig) Unmarshal(parser *confmap.Conf) error {
	if parser == nil {
		return nil
	}
...
type MetricsConfig struct {
	...
	SqlserverDatabaseIoStallQueued              SqlserverDatabaseIoStallQueuedMetricConfig              `mapstructure:"sqlserver.database.io.stall_queued"`
	...
	SqlserverForwardedRecordsRate               SqlserverForwardedRecordsRateMetricConfig               `mapstructure:"sqlserver.forwarded_records.rate"`
	...
	SqlserverTransactionActiveCount             SqlserverTransactionActiveCountMetricConfig             `mapstructure:"sqlserver.transaction.active.count"`
	...
	SqlserverSessionCount                       SqlserverSessionCountMetricConfig                       `mapstructure:"sqlserver.session.count"`
}
...
func DefaultMetricsConfig() MetricsConfig {
	return MetricsConfig{
		...
		SqlserverDatabaseIoStallQueued: SqlserverDatabaseIoStallQueuedMetricConfig{
			Enabled:             false,
			AggregationStrategy: AggregationStrategySum,
			EnabledAttributes:   []SqlserverDatabaseIoStallQueuedMetricAttributeKey{SqlserverDatabaseIoStallQueuedMetricAttributeKeyPhysicalFilename, SqlserverDatabaseIoStallQueuedMetricAttributeKeyLogicalFilename, SqlserverDatabaseIoStallQueuedMetricAttributeKeyFileType, SqlserverDatabaseIoStallQueuedMetricAttributeKeyDirection},
		},
		...
		SqlserverForwardedRecordsRate: SqlserverForwardedRecordsRateMetricConfig{
			Enabled: false,
		},
		...
		SqlserverTransactionActiveCount: SqlserverTransactionActiveCountMetricConfig{
			Enabled: false,
		},
		...
		SqlserverSessionCount: SqlserverSessionCountMetricConfig{
			Enabled: false,
		},
	}
}
