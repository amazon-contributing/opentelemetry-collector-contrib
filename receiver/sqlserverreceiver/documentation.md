...
### sqlserver.transaction.active.count
...
| sqlserver.wait_category | Category of the wait type encountered by the request (e.g. CPU, IO, Lock, Latch, Log, Network, Memory, Remote, Idle, Other). Empty if none. | Any Str | - |
