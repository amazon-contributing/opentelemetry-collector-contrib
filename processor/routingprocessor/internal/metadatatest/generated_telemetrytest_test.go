...
func TestSetupTelemetry(t *testing.T) {
	...
	defer tb.Shutdown()
	tb.RoutingProcessorNonRoutedLogRecords.Add(t.Context(), 1)
	tb.RoutingProcessorNonRoutedMetricPoints.Add(t.Context(), 1)
	tb.RoutingProcessorNonRoutedSpans.Add(t.Context(), 1)
