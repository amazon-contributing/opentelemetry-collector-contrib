...
replace github.com/open-telemetry/opentelemetry-collector-contrib/pkg/aws => /local/home/dricross/workplace/classichistograms/opentelemetry-collector-contrib/pkg/aws
